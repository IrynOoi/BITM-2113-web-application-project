...
@section('styles')
    <style>
        /* ── Dashboard Layout ── */
        .dashboard-page { padding: 40px 0 60px; background: #f9f9f9; }
        .dashboard-layout {
            display: grid;
        ...
        .sidebar-nav form.logout-form button:hover { color: #c0392b; background: #fdf0ef; }
            ...
            <div class="dashboard-layout">
                <div class="dashboard-main" style="grid-column: 1 / -1;">
                    <div class="dashboard-header">
                        <h1>Welcome back, {{ Auth::user()->role === 'admin' ? 'Admin' : 'Staff' }} {{ Auth::user()->full_name }}! 👋</h1>
                        <p>This is the {{ Auth::user()->role }} dashboard. We will port the full {{ Auth::user()->role }} functionality soon.</p>
                        <form method="POST" action="{{ route('logout') }}" style="margin-top: 20px;">
                            @csrf
                            <button type="submit" class="quick-action-card" style="width: auto; padding: 10px 20px; display: inline-flex; flex-direction: row; cursor: pointer;">
                ...
                <div class="dashboard-main">
                    ...
                    <div class="stats-grid">
                        <div class="stat-card">
                            ...
                            <div>
                                <span class="stat-value" id="totalOrders">{{ App\Models\Order::where('user_id', Auth::id())->count() }}</span>
                        ...
                        <div class="stat-card">
                            ...
                            <div>
                                <span class="stat-value" id="pendingOrders">{{ App\Models\Order::where('user_id', Auth::id())->whereIn('status', ['pending', 'preparing', 'confirmed'])->count() }}</span>
                        ...
                        <div class="stat-card">
                            ...
                            <div>
                                <span class="stat-value" id="completedOrders">{{ App\Models\Order::where('user_id', Auth::id())->where('status', 'completed')->count() }}</span>
                        ...
                        <div class="stat-card">
                            ...
                            <div>
                                <span class="stat-value" id="totalSpent">RM {{ number_format(App\Models\Order::where('user_id', Auth::id())->where('status', 'completed')->sum('total'), 2) }}</span>
                    ...
                    <div class="dashboard-section address-card">
                        ...
                        @else
                            <p class="address-empty">
                                ...
                                <a href="{{ route('customer.profile') }}" style="color:#c0392b;font-weight:600;">Add your address</a>
                            ...
                            <table class="orders-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('customer.order-status', ['order_id' => $order->id]) }}" style="color:#c0392b;">View</a></td>
                                    </tr>
                                    @empty
