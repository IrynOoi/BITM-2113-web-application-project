...
<script>
    (function () {
        ...
        const btnL    = document.getElementById('sliderArrowLeft');
        const btnR    = document.getElementById('sliderArrowRight');
        let current   = 0;
        let timer;
        ...
        btnR.addEventListener('click', () => { goTo(current + 1); resetAuto(); });
        btnL.addEventListener('click', () => { goTo(current - 1); resetAuto(); });
