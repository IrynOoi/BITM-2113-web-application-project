            ...
            <form class="auth-form" method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" id="fullName" name="fullName" value="{{ old('fullName') }}" placeholder="Enter your full name" required autofocus autocomplete="name">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="your@email.com" required autocomplete="username">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="tel" id="phone" name="phone" value="{{ old('phone') }}" placeholder="0123456789" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="password" id="password" name="password" placeholder="Create a password (min 8 chars)" required autocomplete="new-password">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <button type="button" class="toggle-password" id="toggleConfirmPwd"><i class="fas fa-eye"></i></button>
                    </div>
                </div>
