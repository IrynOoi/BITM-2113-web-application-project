    ...
    <main class="confirmation-page">
        <div class="container">
            <div class="confirmation-card">
                ...
                <p class="confirmation-subtitle">Thank you for your order. We are preparing it now.</p>

                <div class="order-details-box">
                    <div class="order-detail-row">
                        <span class="detail-label"><i class="fas fa-receipt"></i> Order ID</span>
                        <span class="detail-value" id="confirmOrderId">#{{ $orderId ?? '-------' }}</span>
                    </div>
                    <div class="order-detail-row">
                ...
                <div class="confirmed-items" id="confirmedItems"></div>
                ...
                <div class="confirmation-actions">
                    <a href="{{ route('customer.order-status', ['order_id' => $orderId]) }}" class="btn-primary">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (cart.length > 0) {
                ...
                container.innerHTML = `<div class="confirmed-items-list">
                    ${rows}
