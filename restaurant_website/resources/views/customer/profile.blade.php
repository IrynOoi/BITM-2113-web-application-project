    ...
    <div class="container">
        <div class="dashboard-layout">
            ...
            <div class="dashboard-main">
                ...
                @endif
                @if($errors->any())
                    <div class="alert-error"><i class="fas fa-exclamation-circle"></i> Please check the highlighted fields and try again.</div>
                @endif
                    ...
                    <form class="profile-form" method="POST" action="{{ route('customer.profile.update') }}">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    ...
                                    <input type="text" id="fullName" name="fullName" value="{{ old('fullName', Auth::user()->full_name) }}" required>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <textarea id="address" name="address" rows="3" placeholder="Your default delivery address">{{ old('address', Auth::user()->address) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            ...
                            <a href="{{ route('customer.dashboard') }}" class="btn-cancel-profile"><i class="fas fa-times"></i> Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
